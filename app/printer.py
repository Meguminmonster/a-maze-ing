...
def render_maze(
    ...
    Args:
        grid: 2D list of int, each is a bitmask of walls (N=1, E=2, S=4, W=8).
        entry: Entrance coordinates as (x, y).
        exit_: Exit coordinates as (x, y).
        path: Optional list of (x, y) representing the solution path.
        wall_colour: Colour of the walls, as a colour name string.
        pattern_42: set of positions of 42
    Returns:
        ASCII string representation of the maze, or empty if grid is empty.
    """
...
def write_output_file(
    ...
    Args:
        ...
        entry: Entrance coordinates as (x, y).
        exit_: Exit coordinates as (x, y).
        path: List of strings representing the solution path (N, E, S, W).
