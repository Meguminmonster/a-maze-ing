class Cell:
    ...
    def break_wall(self, direction_bit: int) -> None:
        ...
        Args:
            direction_bit: Wall remove, bitmask constant (N=1, E=2, S=4, W=8).
        """
    ...
    def has_wall(self, direction_bit: int) -> bool:
        ...
        Args:
            direction_bit: Wall check, bitmask constant (N=1, E=2, S=4, W=8).
        Returns:
    ...
    def open_wall_with(self, neighbor: "Cell", direction: int) -> None:
        ...
        Args:
            ...
            direction: Wall open, bitmask constant (N=1, E=2, S=4, W=8).
        """
